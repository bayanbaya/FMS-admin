  ...
  <ul class="nav right">
    <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="fas fa-user-circle"></i>  <span class="text">Welcome Admin</span><b class="caret"></b></a>
      <ul class="dropdown-menu">
        <li><a href="#"><i class="fas fa-user"></i> Profile хэсэг</a></li>
        <li class="divider"></li>
        <!-- <li><a href="#"><i class="fas fa-check"></i> My Tasks</a></li>
        <li class="divider"></li> -->
        <li><a href="../logout.php"><i class="fas fa-key"></i> Гарах</a></li>
      </ul>
    </li>
    <li class=""><a title="" href="../logout.php"><i class="fas fa-power-off"></i> <span class="text">Гарах</span></a></li>
  </ul>
